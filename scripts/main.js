...
// Using the for each method to access each object inside the array
// businesses.forEach(business => {
//     let zipcode = [];
//     zipcode.push(business["addressZipCode"])
//     outEl.innerHTML += `
...
const totalRainfall = monthlyRainfall.reduce((currentValue, nextValue) => currentValue += nextValue, 0)
